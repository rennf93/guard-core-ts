...
> **configureCors**(`fastify`, `config`): `Promise`\<`void`\>

Defined in: [fastify/src/cors.ts:4](https://github.com/rennf93/guard-core-ts/blob/b49ed8cdbf992765ff7882327eaf5f8a9461242e/packages/fastify/src/cors.ts#L4)
